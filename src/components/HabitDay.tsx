...
export function HabitDay({ defaultCompleted = 0, amount = 0, date }: HabitDayProps) {
   ...
   const completedPorcentage = amount > 0 ? (completed / amount) * 100 : 0;
   ...
   return (
      <Popover.Root>
         <Popover.Trigger className={clsx("w-10 h-10 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-600 focus:ring-offset-2 focus:ring-offset-background", {
